                                                     ...
                                                     Uint32                 NumDeferredContexts)
{
    ...
    *ppDevice = nullptr;
    ...
    try
    {
        ...
        stl::vector<const char*> DeviceExtensions = 
        { 
        ...
        stl::array<ICommandQueueVk*, 1> CommandQueues = {{pCmdQueueVk}};
        AttachToVulkanDevice(Instance, stl::move(PhysicalDevice), LogicalDevice, CommandQueues.size(), CommandQueues.data(), CreationAttribs, ppDevice, ppContexts, NumDeferredContexts);
        ...
        pCmdQueueVk->SetFence(stl::move(pFenceVk));
    }
                                               ...
                                               Uint32                 NumDeferredContexts)
{
    ...
    *ppDevice = nullptr;
    ...
    {
        auto &RawMemAllocator = GetRawAllocator();
        RenderDeviceVkImpl *pRenderDeviceVk( NEW_RC_OBJ(RawMemAllocator, "RenderDeviceVkImpl instance", RenderDeviceVkImpl)(RawMemAllocator, EngineAttribs, CommandQueueCount, ppCommandQueues, Instance, stl::move(PhysicalDevice), LogicalDevice, NumDeferredContexts ) );
