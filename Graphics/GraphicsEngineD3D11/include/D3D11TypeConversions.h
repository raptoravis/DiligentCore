...
void LayoutElements_To_D3D11_INPUT_ELEMENT_DESCs(const stl::vector<LayoutElement, STDAllocatorRawMem<LayoutElement> > &LayoutElements, 
                                                 stl::vector<D3D11_INPUT_ELEMENT_DESC, STDAllocatorRawMem<D3D11_INPUT_ELEMENT_DESC> > &D3D11InputElements);
